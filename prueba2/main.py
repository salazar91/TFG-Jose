...
class Root(FloatLayout):
	...
	def siguiente(self):
		...
		#print("Hola")
		#print (cpx,cpy)
		self.matreal=devolvermatreal(ag,ap,filas,columnas,cpx,cpy)  #Te devuelve la matriz con el fichero
		print (self.matreal)
		...
		if numimagenactual < self.numero_imagenes:
			...
			self.rellenarmatriz(self.matreal) #A�adir el valor de posiciones vacias (Seran las imagenes(self.numero_imagenes)- las que llevamos recorridas(numimagenactual))
