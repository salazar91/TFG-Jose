...
def creargrafica(nombrefichero, diferencia):
    Counted=[]
    CError=[]
    with open(f'./Datos analisis/simulaciones{nombrefichero}_{diferencia}.txt') as f:
        content = f.readlines()
    ...
    plt.savefig(dir_fig+f"./Datos analisis/TFG_JOSE{nombrefichero}_{diferencia}.png")
    plt.clf()
